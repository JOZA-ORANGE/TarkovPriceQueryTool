...
class Ui_EFTPQ_UI(object):
    def setupUi(self, EFTPQ_UI):
        ...
        icon = QIcon()
        icon.addFile(u"./sourse/eft_logo.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u"./sourse/github_logo.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u"./sourse/bilibili_logo.svg", QSize(), QIcon.Normal, QIcon.Off)
